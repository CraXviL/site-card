$(document).ready(function () {
	...
	var blockHeights = {
		...
		calcBlockHeight: function calcBlockHeight() {
			this.heightTopPart = parseInt($('header').css('height'), 10) + parseInt($('#main').css('height'), 10);
			this.heightMiddlePart = parseInt($('#about').css('height'), 10) + parseInt($('#skills').css('height'), 10);
	...
	$(window).resize(function () {
		return blockHeights.calcBlockHeight();
	});
	...
	$('.navbar-nav a').on('click', function (e) {
		...
		switch (e.target.id) {
			case 'menu-about':
				...
				break;
			case 'menu-portfolio':
				$('html').animate({ scrollTop: blockHeights.heightTopPart + blockHeights.heightMiddlePart + 200 });
				window.location = '#portfolio';
				break;
			case 'menu-contacts':
				$('html').animate({ scrollTop: blockHeights.heightTopPart + blockHeights.heightMiddlePart + blockHeights.heightPortfolioBlock + 200 });
				window.location = '#order';
				break;
		}
	});

	$('#portfolio ul a').on('click', function (e) {
		e.preventDefault();
